...
if(isset($_POST['h_search'])){
   ...
   $select_properties = $conn->prepare("SELECT * FROM `property` WHERE address LIKE '%{$h_location}%' AND type LIKE '%{$h_type}%' AND offer LIKE '%{$h_offer}%' ORDER BY date DESC");
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"> <b> Rs </b> <span><?= $fetch_property['price']; ?></span></div>
