...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, price, type, offer, status, furnished, bhk, bathroom, balcony, age,   loan,  garden, water_supply, power_backup, parking_area,  image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_property->execute([$id, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $bhk,  $bathroom, $balcony, $age,  $loan, $garden, $water_supply, $power_backup, $parking_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <!-- <div class="box">
            ...
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder=" Deposite Amount" class="input">
         </div> -->
         <div class="box">
            <p>Property Address <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="Property Address" class="input">
         </div>
         <div class="box">
