...
<footer class="footer">
   ...
   <section class="flex">
      ...
      <div class="box">
         ...
         <a href="myhome24@gmail.com"><i class="fas fa-envelope"></i><span>myhome24@gmail.com</span></a>
   ...
   <div class="credit">&copy; Copyright @ <?= date('Y'); ?> by <span>Sagarmatha Engineering College </span> | All Rights Reserved!</div>
